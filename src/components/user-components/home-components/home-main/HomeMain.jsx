...
function HomeMain() {
  ...
  return (
    <>
      {isMobile && (
        <div className=' flex flex-col items-center justify-center mt-16 sm:mt-36 bg-gray-50 border p-8 w-fit rounded-xl mx-auto shadow-xl'>
          <div className=' sm:w-96'>
            <div className='flex flex-col gap-2 my-6'>
              <h3 className='fs font-bold text-2xl sm:text-3xl text-left'>
              ...
              <p className='fs  text-sm sm:text-lg text-left'>Discover entire homes and rooms perfect for any trip.</p>
            </div>
            <div className=' h-auto w-3/ mx-auto '>
              ...
              <button
                className='bg-cyan-900 rounded-xl w-full py-2 hover:bg-cyan-800 text-gray-50 hover:text-gray-50 duration-300 '
      ...
      <div className='mt-16 md:mx-20'>
        <div className='  flex flex-col bg-gray-30 md:flex-row items-center justify-center h- md:justify-between  cover-div  '>
          ...
          <div className='md:w-1/2 coverpic h- w-full object-cover  '>
            <img loading='lazy' className=' w-full object-cover coverpic bg-white ' src={myImage} />
          </div>
        </div>
      </div>
      <div className='mt-16 md:mx-20 '>
      ...
      <footer className=' w-full  flex justify-center items-center  tracking-wider bg-white shadow-xl '>
        <div className=' border-t p-4 w-full sm:mx-10 text-center text-xs sm:text-sm border-gray-700 fontfm'>
